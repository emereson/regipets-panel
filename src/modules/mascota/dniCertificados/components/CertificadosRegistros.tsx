...
const CertificadosRegistros = ({ mascotas, isOpen, onOpenChange }: Props) => {
      ...
      for (let i = 0; i < mascotas.length; i++) {
        ...
        if (imageBytes) {
          try {
            ...
            const imgHeight = 80;
            const imgX = 90;
            const imgY = page.getHeight() - imgHeight - 60;
        ...
        {() => (
          <>
            <ModalHeader className="text-[#1c61b6]">
              CERTIFICADOS DE REGISTRO ({mascotas.length})
            </ModalHeader>
...
export default CertificadosRegistros;
