...
const ModalEditMascota = ({
  ...
  const [selectDepartamento, setSelectDepartamento] = useState<string>(
    (mascota?.departamento_id as string) || ""
  );
  const [selectProvincia, setSelectProvincia] = useState<string>(
    (mascota?.provincia_id as string) || ""
  );
  const [selectDistrito, setSelectDistrito] = useState<string>(
    (mascota?.distrito_id as string) || ""
  );

  useEffect(() => {
    if (mascota?.especie_id) {
      setSelectEspecie(mascota.especie_id as unknown as string);
    }
    if (mascota.mascota_raza_id) {
      setSelectRaza(mascota.mascota_raza_id as string);
    }
  }, [mascota, setSelectEspecie, setSelectRaza]);
  ...
  const submit = async (data: Mascota) => {
    ...
    Object.entries(data).forEach(([key, value]) => {
      if (value && key !== "imagen") formData.append(key, value as string);
    });
          ...
          <form className="flex flex-col gap-3" onSubmit={handleSubmit(submit)}>
            ...
            <div className="w-full flex  gap-2">
              ...
              <Input
                ...
                classNames={inputClassNames}
                label="DNI / CE  responsable 2"
                labelPlacement="outside"
                placeholder="..."
                variant="bordered"
                {...register("dni_responsable_2")}
                color="primary"
                radius="sm"
                size="sm"
              />
              <Input
                ...
                className="min-w-[180px] max-w-[180px]"
                classNames={inputClassNames}
                label="Telefono responsable 2"
                labelPlacement="outside"
                placeholder="..."
                variant="bordered"
                {...register("telefono_responsable_2")}
                color="primary"
                radius="sm"
                size="sm"
              />
              ...
              <div className="w-full flex flex-col gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  <Select
                    ...
                    size="sm"
                    {...register("tamano")}
                    defaultSelectedKeys={[mascota.tamano || ""]}
                  >
            ...
            <div className="w-full flex gap-1">
              ...
              <Select
                ...
                defaultSelectedKeys={[mascota.calificacion || ""]}
              >
              ...
              <Select
                ...
                radius="sm"
                size="sm"
                selectedKeys={selectEspecie ? [selectEspecie.toString()] : []}
              ...
              <Autocomplete
                ...
                selectedKey={(selectRaza && selectRaza.toString()) || ""}
            ...
            <div className="w-full flex gap-1">
              <Select
                ...
                size="sm"
                selectedKeys={
                  selectDepartamento ? [selectDepartamento.toString()] : []
                }
              ...
              <Select
                ...
                selectedKeys={
                  selectProvincia ? [selectProvincia.toString()] : []
                }
              ...
              <Select
                ...
                selectedKeys={selectDistrito ? [selectDistrito.toString()] : []}
